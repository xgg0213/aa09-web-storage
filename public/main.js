...
function storeName(displayName) {
    // Your code here 
    window.sessionStorage.setItem("display-name", displayName);
...
function restoreName() {
    // Your code here 
    const displayName = window.sessionStorage.getItem("display-name");
    if (displayName) {
...
function clearName() {
    // Your code here 
    window.sessionStorage.removeItem("display-name");
}
